                        ...
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td className="ro">950 руб.</td>
                                    <td className="ro">760 руб.</td>
                                    <td className="ro">855 руб.</td>
                                    <td className="ro">590 руб.</td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>Маленькие длинношерстные породы</td>
                                    <td className="ro">1 250 руб.</td>
                                    <td className="ro">1 000 руб.</td>
                                    <td className="ro">1 125 руб.</td>
                                    <td className="ro">850 руб.</td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>Средние породы</td>
                                    <td className="ro">1400 - 2250 руб.</td>
                                    <td className="ro">1120 - 1800 руб.</td>
                                    <td className="ro">1260 - 2025 руб.</td>
                                    <td className="ro">1 100 руб.</td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>Крупные породы</td>
                                    <td className="ro">от 1 690 руб.</td>
                                    <td className="ro">от 1 360 руб.</td>
                                    <td className="ro">1 520 руб.</td>
                                    <td className="ro">1 500 руб.</td>
